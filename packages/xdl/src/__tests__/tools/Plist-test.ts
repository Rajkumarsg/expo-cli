...
`;
  ...
  describe('array', function() {
    ...
    it('should parse an array with multiple elements', function() {
      var parsed = parseFixture('<array><string>1</string><string>2</string></array>');
  ...
  describe('dict', function() {
    ...
    it('should parse multiple key/value pairs', function() {
      var parsed = parseFixture('<dict><key>a</key><true/><key>b</key><false/></dict>');
      assert.deepEqual(parsed, { a: true, b: false });
    });

    it('should parse nested data structures', function() {
      var parsed = parseFixture('<dict><key>a</key><dict><key>a1</key><true/></dict></dict>');
